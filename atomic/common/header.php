...
if (!(rtrim(current_url(), "/") == exhibit_builder_exhibit_uri())) {
	...
	echo '<img src="' . html_escape(url('themes/atomic/images/banner.jpg')) . '" alt="Banner Image. ' . metadata('exhibit', 'title') . '" title="' . metadata('exhibit', 'title') . '"/></a>';
}
?>
...
if (rtrim(current_url(), "/") == exhibit_builder_exhibit_uri()) {
	...
	echo '<img id="titleimage" src="' . html_escape(url('themes/atomic/images/title.jpg')) . '"  alt="Title Image. ' . metadata('exhibit', 'title') . '" title="' . metadata('exhibit', 'title') . '"/></a>';
}
?>
