...
if (!(rtrim(current_url(), "/") == exhibit_builder_exhibit_uri())) {
	echo '<a href="' . exhibit_builder_exhibit_uri() . '" style="text-decoration: none;">';
//	echo '<img src="' . html_escape(url('themes/blackexcellence/images/banner.png')) . '" alt="Banner Image. ' . metadata('exhibit', 'title') . '" title="' . metadata('exhibit', 'title') . '"/></a>';
	echo '<h1>' . metadata('exhibit', 'title') . '</h1></a>';
}
?>
...
?>
		...
		<h5><a href="<?php echo html_escape(url('items/search?collection=6')); ?>">Search Items</a></h5>
...
if (rtrim(current_url(), "/") == exhibit_builder_exhibit_uri()) {
	...
	echo '<img id="titleimage" src="' . html_escape(url('themes/blackexcellence/images/title.png')) . '"  alt="Title Image. ' . metadata('exhibit', 'title') . '" title="' . metadata('exhibit', 'title') . '"/>';
}
?>
